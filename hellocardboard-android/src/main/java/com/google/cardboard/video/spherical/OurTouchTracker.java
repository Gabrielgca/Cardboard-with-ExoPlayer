 ...
 */
/* package */ final class OurTouchTracker extends GestureDetector.SimpleOnGestureListener
        implements View.OnTouchListener, OurOrientationListener.Listener {
    ...
    public OurTouchTracker(Context context, Listener listener, float pxPerDegrees) {
        this.listener = listener;
        this.pxPerDegrees = pxPerDegrees;
        gestureDetector = new GestureDetector(context, this);
        roll = OurSphericalGLSurfaceView.UPRIGHT_ROLL;
    }
