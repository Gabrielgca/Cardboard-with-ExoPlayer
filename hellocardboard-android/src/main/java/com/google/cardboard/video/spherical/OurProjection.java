...
/* package */ final class OurProjection {
     ...
     */
    public static OurProjection createEquirectangular(@C.StereoMode int stereoMode) {
     ...
     */
    public static OurProjection createEquirectangular(
            float radius,
            int latitudes,
            int longitudes,
        ...
        OurProjection.SubMesh subMesh =
                new OurProjection.SubMesh(OurProjection.SubMesh.VIDEO_TEXTURE_ID, vertexData, textureData, DRAW_MODE_TRIANGLES_STRIP);
        return new OurProjection(new OurProjection.Mesh(subMesh), stereoMode);
    }

    /** The Mesh corresponding to the left eye. */
    public final OurProjection.Mesh leftMesh;
    /**
     * The Mesh corresponding to the right eye. If {@code singleMesh} is true then this mesh is
     * identical to {@link #leftMesh}.
     */
    public final OurProjection.Mesh rightMesh;
    /** The stereo mode. */
     ...
     */
    public OurProjection(Mesh mesh, int stereoMode) {
        this(mesh, mesh, stereoMode);
    }

    /**
     * Creates a Projection with dual mesh. Use {@link #OurProjection(Mesh, int)} if there is single mesh
     * for both eyes.
     *
     ...
     * @param stereoMode A {@link C.StereoMode} value.
     */
    public OurProjection(Mesh leftMesh, Mesh rightMesh, int stereoMode) {
    ...
    public static final class SubMesh {
        ...
        /** The drawing mode. One of {@link OurProjection.DrawMode}. */
        public final @DrawMode
        int mode;
