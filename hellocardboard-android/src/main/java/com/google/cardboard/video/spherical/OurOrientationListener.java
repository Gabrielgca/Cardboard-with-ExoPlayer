 ...
 */
/* package */ final class OurOrientationListener implements SensorEventListener {
    ...
    public OurOrientationListener(Display display, Listener... listeners) {
    ...
    private void recenter(float[] matrix) {
        if (!recenterMatrixComputed) {
            OurFrameRotationQueue.computeRecenterMatrix(recenterMatrix4x4, matrix);
