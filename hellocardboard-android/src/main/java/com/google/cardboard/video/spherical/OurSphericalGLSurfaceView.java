...
public final class OurSphericalGLSurfaceView extends GLSurfaceView {
    ...
    private final OurOrientationListener orientationListener;
    private final Handler mainHandler;
    private final OurTouchTracker touchTracker;
    private final OurSceneRenderer scene;
    ...
    public OurSphericalGLSurfaceView(Context context) {
        this(context, null);
    }

    public OurSphericalGLSurfaceView(Context context, @Nullable AttributeSet attributeSet) {
        ...
        scene = new OurSceneRenderer();
        Renderer renderer = new Renderer(scene);

        touchTracker = new OurTouchTracker(context, renderer, PX_PER_DEGREES);
        WindowManager windowManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
        Display display = Assertions.checkNotNull(windowManager).getDefaultDisplay();
        orientationListener = new OurOrientationListener(display, touchTracker, renderer);
    ...
    /* package */ final class Renderer
            implements GLSurfaceView.Renderer, OurTouchTracker.Listener, OurOrientationListener.Listener {
        private final OurSceneRenderer scene;
        ...
        public Renderer(OurSceneRenderer scene) {
            this.scene = scene;
