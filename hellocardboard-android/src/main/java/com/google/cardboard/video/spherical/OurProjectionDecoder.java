...
import com.google.cardboard.video.spherical.OurProjection.Mesh;
import com.google.cardboard.video.spherical.OurProjection.SubMesh;
 ...
 */
/* package */ final class OurProjectionDecoder {
    ...
    OurProjection decode(byte[] projectionData, @C.StereoMode int stereoMode) {
        ...
        if (meshes == null) {
            ...
            switch (meshes.size()) {
                case 1:
                    return new OurProjection(meshes.get(0), stereoMode);
                case 2:
                    return new OurProjection(meshes.get(0), meshes.get(1), stereoMode);
                case 0:
                default:
                    return null;
            }
