 ...
 * be obtained from {@link OurSimpleExoPlayer.Builder}.
 */
public class OurSimpleExoPlayer extends BasePlayer
    ...
    /**
     * A builder for {@link OurSimpleExoPlayer} instances.
     *
    ...
    public static final class Builder {
        ...
        /**
         * Builds a {@link OurSimpleExoPlayer} instance.
         *
         * @throws IllegalStateException If this method has already been called.
         */
        public OurSimpleExoPlayer build() {
            Assertions.checkState(!buildCalled);
            buildCalled = true;
            return new OurSimpleExoPlayer(/* builder= */ this);
        }
    }

    private static final String TAG = "OurSimpleExoPlayer";
    ...
    @Nullable private OurSphericalGLSurfaceView ourSphericalGLSurfaceView;
    ...
    /** @deprecated Use the {@link Builder} and pass it to {@link #OurSimpleExoPlayer(Builder)}. */
    @Deprecated
    protected OurSimpleExoPlayer(
            Context context,
            RenderersFactory renderersFactory,
            TrackSelector trackSelector,
            MediaSourceFactory mediaSourceFactory,
    ...
    protected OurSimpleExoPlayer(Builder builder) {
    ...
    public void setVideoSurfaceView(@Nullable SurfaceView surfaceView) {
        ...
        if (surfaceView instanceof VideoDecoderOutputBufferRenderer) {
            ...
            setNonVideoOutputSurfaceHolderInternal(surfaceView.getHolder());
        } else if (surfaceView instanceof OurSphericalGLSurfaceView) {
            removeSurfaceCallbacks();
            ourSphericalGLSurfaceView = (OurSphericalGLSurfaceView) surfaceView;
            player
                    .createMessage(frameMetadataListener)
                    .setType(FrameMetadataListener.MSG_SET_SPHERICAL_SURFACE_VIEW)
                    .setPayload(ourSphericalGLSurfaceView)
                    .send();
            ourSphericalGLSurfaceView.addVideoSurfaceListener(componentListener);
            setVideoOutputInternal(ourSphericalGLSurfaceView.getVideoSurface());
            setNonVideoOutputSurfaceHolderInternal(surfaceView.getHolder());
        }
        else {
    ...
    private void removeSurfaceCallbacks() {
        ...
        if (ourSphericalGLSurfaceView != null) {
            player
                    .createMessage(frameMetadataListener)
                    .setType(FrameMetadataListener.MSG_SET_SPHERICAL_SURFACE_VIEW)
                    .setPayload(null)
                    .send();
            ourSphericalGLSurfaceView.removeVideoSurfaceListener(componentListener);
            ourSphericalGLSurfaceView = null;
        }
        if (textureView != null) {
    ...
    private final class ComponentListener
            ...
            OurSphericalGLSurfaceView.VideoSurfaceListener,
        ...
        public void onVideoSizeChanged(VideoSize videoSize) {
            OurSimpleExoPlayer.this.videoSize = videoSize;
        ...
        public void onSkipSilenceEnabledChanged(boolean skipSilenceEnabled) {
            if (OurSimpleExoPlayer.this.skipSilenceEnabled == skipSilenceEnabled) {
                return;
            }
            OurSimpleExoPlayer.this.skipSilenceEnabled = skipSilenceEnabled;
            notifySkipSilenceEnabledChanged();
        }
        ...
        public void onStreamTypeChanged(@C.StreamType int streamType) {
            ...
            if (!deviceInfo.equals(OurSimpleExoPlayer.this.deviceInfo)) {
                OurSimpleExoPlayer.this.deviceInfo = deviceInfo;
        ...
        public void handleMessage(int messageType, @Nullable Object payload) {
            switch (messageType) {
                ...
                case MSG_SET_SPHERICAL_SURFACE_VIEW:
                    OurSphericalGLSurfaceView surfaceView = (OurSphericalGLSurfaceView) payload;
                    if (surfaceView == null) {
